...
console.warn("----------Question 1:arrow function with no argument with no return value--------");
let show=()=>{
    console.log("Good Evening,Today is Friday");
}
show();
console.warn("----------Question 2:Multiplication of three numbers with by giving third default value--------");
...
console.warn("----------Question 3:Print addition of five numbers--------");
