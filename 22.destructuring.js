...
//  let isMarried = person.isMarried;
 ...
 let { fullName, city, pin, state, isMarried,country="India" }  = person;
 console.log(fullName, city, pin, state, isMarried,country);
 console.warn("-----------------------------------------------------------------");
...
//  let ele5 =  arrayOfNames[5];
 let [ele0, ele1, ele2, ele3, ele4,ele5,ele6="Janu" ] = arrayOfNames;
